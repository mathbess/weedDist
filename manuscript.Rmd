...
****Comments from Benoît:**
- Is it really a sensitivity analysis? We're actually testing different scenarios.  
The paper has two parts: first the curve fit and the scenario variation.
What may be useful to the first part:
